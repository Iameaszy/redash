...
export const social_auth = (obj, social_type) => {
  return (dispatch) => {
    dispatch({ type: authActions.SIGNIN_REQUEST });
...
export const forget_password = (obj) => {
  return (dispatch) => {
...
export const reset_password = (obj, query) => {
  return (dispatch) => {
    dispatch({ type: authActions.FORGOT_PASSWORD_REQUEST });
    axios({
...
export const verify_email = (query) => {
  return (dispatch) => {
...
export const get_email_link = (userid, force) => {
  return (dispatch) => {
